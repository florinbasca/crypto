...
For each feature you are told WHAT IT MEASURES, its recent correlation with the forward residual target, the shape of that relationship (decile curve), its stability, and how it shifts across market regimes. Treat these as EVIDENCE — then reason about the MECHANISM: WHY would this predict? (positioning unwinds, funding carry and its mean-reversion, liquidity provision and short-horizon reversal, information diffusion and lead-lag between coins, volatility-regime shifts, event-driven repricing.)
